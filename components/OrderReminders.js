...
export default function OrderReminders() {
  return (
    <section id="about" className="bg-cream py-4 md:py-4">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2
          className="font-playfair text-3xl sm:text-4xl md:text-5xl font-bold text-brown mb-6 md:mb-10 uppercase tracking-wide"
        ...
        <div className="space-y-5 md:space-y-6">
          <div className="bg-white rounded-2xl p-5 sm:p-6 md:p-8 shadow-sm">
            <div className="max-w-5xl mx-auto space-y-5 md:space-y-8">
              <p className="text-brown text-base sm:text-lg md:text-2xl lg:text-3xl leading-7 sm:leading-8 md:leading-relaxed text-center">
          ...
          <div className="bg-white rounded-2xl p-4 sm:p-5 md:p-6 shadow-sm flex flex-col md:flex-row items-stretch gap-4 md:gap-5">
            ...
            <div className="flex-1 flex flex-col justify-center p-1 sm:p-2 md:p-4">
              <h3 className="font-playfair text-xl sm:text-2xl md:text-3xl font-bold text-brown mb-2 md:mb-3 uppercase leading-tight">
                Product List &amp; Prices
              </h3>
              <p className="text-brown-light text-base md:text-lg leading-7 md:leading-relaxed">
              ...
              <p className="text-brown-light text-base md:text-lg leading-7 md:leading-relaxed mt-4 md:mt-6">
